...
define('CAMPAIGN_ID', "f9d8f3e28422b720121428c4a904a599");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'd3ded0aa33d507787bb7b9e0bae7c6c8');
define('MP_PARAM_NAME', '_grclk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '4bdea9077d982c78b3940e337886accb');
define('CHECK_MCPROXY_VALUE', '6afab3c4c8b56585d27dc0f5e6a1655edbb10f41ad8de775b6c66515bfef59ba');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '22416.3');
